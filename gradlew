...
Please set the JAVA_HOME variable in your environment or add the 'java' executable to your PATH."
fi
...
# Add default JVM options here. You can also use JAVA_OPTS and GRADLE_OPTS to pass JVM options to this script.
# This handles Gradle's "daemon not found" errors on restricted environments
